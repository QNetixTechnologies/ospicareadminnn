...
if(mysqli_num_rows($result) > 0){
    ...
    $queryInsert = "insert into doctor_table (names, phone_number, email, password, image_path, specialty, hospital_id) values('$names', '$phonenumber', '$email', '$password', '$pp', '$specialty', '$hospitalID')";
